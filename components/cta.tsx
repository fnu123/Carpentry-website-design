      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-secondary-foreground/70 text-lg mb-10">
            Get a free, no-obligation estimate for your carpentry or deck building project. 
            We&apos;re ready to bring your vision to life.
          </p>
          <Link href="#contact">
            <Button
              size="lg"
              className="bg-primary hover:bg-gold-dark text-primary-foreground font-semibold text-lg px-10 py-6 group"
            >
              Get Free Quote
